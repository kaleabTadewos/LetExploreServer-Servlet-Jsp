        ...
        <div id="middle">
            <div id="sidebar-left">
                ...
                <div id="orgLinks" class="module-box">
                    <span>Look Up</span>
                    <ul>
                        <li><a href="tourlocationcontrollerlist">Tour Location</a></li>
                        <li><a href="tourguidecontrollerlist">Tour Guides</a></li>
            ...
            <div id="content">
                <table>
                	...
                	<tbody>
                		<c:forEach var="newslist" items="${news}" varStatus="iteration">
                			<tr>
                				<th scope="row"><c:out value="${iteration.index+1}"></c:out>.</th>
		                        <td><c:out value="${newslist.title}"></c:out></td>
		                        <td><img src=" <c:out value="${newslist.imgPath}"></c:out>"  /></td>
                			</tr>
                		</c:forEach>
                	</tbody>
                </table>
